...
/// Entry-point card for the customer analytics screen. Pure navigation —
/// the heavy aggregation runs only when the user taps in.
class CustomersCard extends StatelessWidget {
  const CustomersCard({super.key, required this.onTap});
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(Icons.people_alt_rounded, color: MangoThemeFactory.info, size: dpi.icon(22)),
            ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Ranking por gasto, recurrencia y RNC del periodo',
